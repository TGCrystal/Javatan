...
public class Settlement {
	...
	*/
	...
	private void makeAHouse(String color) {
		type = Type.HOUSE;
		theRoot.getChildren().remove(placeSettlementBtn);
		Image anImage = null;
		if (color.equals("red")) {
			anImage = new Image(getResourceString("redHouse.png"), 25, 25, false, false);
		} else if (color.equals("orange")) {
			anImage = new Image(getResourceString("orangeHouse.png"), 25, 25, false, false);
		} else if (color.equals("white")) {
			anImage = new Image(getResourceString("whiteHouse.png"), 25, 25, false, false);
		} else if (color.equals("blue")) {
			// anImage = new Image("blueHouse.png", 25, 25, false, false);
			anImage = new Image(getResourceString("blueHouse.png"), 25, 25, false, false);
		}
	...
	private void makeCity(String color) {
		theRoot.getChildren().remove(houseImg);
		Image anImage = null;
		if (color.equals("red")) {
			anImage = new Image(getResourceString("redCity.png"), 25, 25, false, false);
		} else if (color.equals("orange")) {
			anImage = new Image(getResourceString("orangeCity.png"), 25, 25, false, false);
		} else if (color.equals("white")) {
	...
	private String getResourceString(String imageName) {
		return getClass().getResource(imageName).toString();
	}
